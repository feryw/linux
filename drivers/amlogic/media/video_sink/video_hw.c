...
#else
#define VIDEO_LAYER_ON_CAPTURE_INIT() do {} while (0)
#define VIDEO_LAYER_OFF_CAPTURE_DEINIT() do {} while (0)
#endif
...
#define VIDEO_LAYER_OFF() \
	do { \
		...
		VIDEO_LAYER_OFF_CAPTURE_DEINIT(); \
		spin_unlock_irqrestore(&video_onoff_lock, flags); \
	} while (0)
