...
#define SPRDWL_TX_DATA_TIMEOUT	6000

#define SPRDWL_TX_MSG_CMD_NUM 128
#define SPRDWL_TX_QOS_POOL_SIZE 40000
...
struct sprdwl_intf {
	...
	unsigned long rx_num[MAX_LUT_NUM];
	signed char signal[MAX_LUT_NUM];
	unsigned char snr[MAX_LUT_NUM];
	unsigned char data_rate[MAX_LUT_NUM];
...
#define SPRDWL_PS_RESUMED  0
	...
	u32 global_tokens;
	unsigned long last_global_update;
};
